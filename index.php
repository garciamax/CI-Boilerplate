 ...
 *
 */
define('GRM_DEVELOPMENT', 'development');
define('GRM_STAGING'    , 'staging');
define('GRM_PRODUCTION' , 'production');

define('ENVIRONMENT', (isset($_SERVER['GRM_ENV']) ? $_SERVER['GRM_ENV'] : GRM_DEVELOPMENT));
/*
 *---------------------------------------------------------------
 * ERROR REPORTING
 *---------------------------------------------------------------
